...
def dmnetLong(pretrained_weights=None, input_size=(512, 512, 1)):
    ...
    conv10 = Conv2D(1, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv9)
    ...
    z = Conv2D(128, (3, 3), activation='relu', padding='same')(conv10)
    # z = Flatten()(z)
